...
- A key takeaway from a Zoom call gets logged in Confluence.
- A Loom video is embedded alongside project updates so the full context is front and center.
- An off-hand insight in Slack becomes a quick FAQ entry or gets added to a decision log.
...
Getting there takes more than just good intentions. It means breaking old habits — like the idea that hoarding information creates job security — and replacing them with a new mindset: Knowledge sharing makes *everyone* better. As Fosslien noted, Atlassian’s own culture of openness (one of our [core values](https://www.atlassian.com/company/values) is “Open company, no BS”) means that new hires (and new technologies like generative AI) can access a wealth of information from day one instead of finding everything locked behind permissions.

How do you create that kind of culture? Start with the basics:

- Model the behavior. Share what you know, even if it feels small.
- Don’t penalize mistakes that come from thoughtful risk-taking or learning.
- Encourage teams to create “evergreen” project pages or playbooks in a tool like Confluence and recognize those who contribute to them.
- Incentivize knowledge-sharing by making it part of performance reviews or by celebrating top contributors to internal knowledge forums. Even small practices, like ending a project debrief with “Let’s write up our lessons learned and key decisions,” can reinforce the habit.
