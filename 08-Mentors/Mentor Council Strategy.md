# Mentor Council Strategy

#strategy #mentors #network

> **Status:** v1 — May 24, 2026
> **Owner:** Giuseppe + Wolf
> **Source pool:** 14 LinkedIn profiles in 00-Raw/ (1 existing mentor + 13 candidates)
> **Decision needed:** which 3 candidates to formally approach as additional mentors
...
## Why These Three — The Complementarity Logic
...
- **What he unlocks:**
  ...
  - SME digital-transformation client patterns (objection handling, trust building)
  - Direct experience of what kills AI-services pilots in DACH Mittelstand
- **Complementarity:** Oliver vQ has no consulting-practice operating experience. The v6 reframe ([[Product Evolution Log]] — Francis de Vericourt and Marco Nortmeier convergence) makes this gap structural, not optional.
- **One-line ask framing:** "We are repositioning from 'AI startup' to 'consulting practice with AI methodology' — exactly the model Heuristiq runs. Would you mentor us on the operating playbook?"
...
- **One-line ask framing:** "We are building toward serving PE-side deal protection — we need financial-DD credibility we currently lack. Would you mentor us on financial discipline and DD readiness?"
...
- **Helmut Kranzmaier** — see above
- **Simon Kozlik** — see above
- **Joachim Behrendt** — see above

### Moderate fit (worth keeping warm, not top-3 ask)
...
## Existing Mentor — Oliver von Quast (profile reference)

**Source:** 00-Raw/Dr. Oliver von Quast.md (LinkedIn)

- **Current:** Co-Founder & MD DirectCharge GmbH (e-car charging from PV/wind); Founder ZerRes (audiophile furniture); Founder & MD Sarvovelo Capital (11+ years portfolio investing — utilities, cleantech, smart city, IoT); Project Manager A² Adlershof Accelerator (WISTA, 10+ years); Co-Founder COO ENESTO; Shareholder & Mentor Medicinisto AG
...
- [[1 to 1s — Week 6]] — Mentor Day prep reference
- [[Interview 023 — Maciej Bogacz (Holon Translink, Poland)]] — M&A wedge quantification source
- [[Interview 020 — Francis de Vericourt (ESMT Professor)]] — "access not technology" reframe driving consulting-practice identity
- [[Interview 022 — Marco Nortmeier (Filigran, Germany)]] — methodology-as-moat operational confirmation
