# MI — Why Now Is the Knowledge Management Moment (Atlassian)

#market-intelligence #why-now #knowledge-management #ai-adoption

> **Source:** Atlassian blog — "Follow-on blog: why now is the knowledge management moment"
> **Author:** Sheila Ornelas (Atlassian); featuring Julie Mohr, Principal Analyst at Forrester
> **Published:** July 2025
> **Date captured:** May 2026
> **Type:** Industry analysis — Atlassian/Forrester webinar summary

---

## What This Says

Atlassian and Forrester argue that the generative AI boom is forcing a reckoning with organizational knowledge quality. The punchline: *"Generative AI is only as smart as your knowledge base."* Teams have more information than ever but have never been less informed — because scattered, outdated, siloed knowledge doesn't just slow teams down; it turns AI initiatives into expensive failures.

Three key takeaways from the Atlassian/Forrester webinar:
1. The value of generative AI depends entirely on knowledge quality
2. Knowledge is more than documents — it includes conversations, calls, informal exchanges
3. Collaboration and culture are the backbone of effective knowledge management
...
## Key Stat for Pitch Deck

**25% of work week = information search** (Atlassian 2025 State of Teams)

Combined with the Mem stat (2.5 hours/day), HAIC-MM (40% productivity gains from effective human-AI collaboration), and Maciej's ROI frame (40-60x), this builds a credible quantitative case for the problem size.
...
- [[MI — Mem (a16z Podcast)]] — 2.5 hours/day search stat, hidden reinvention
- [[MI — HAIC-MM (Ortolano & Gallegos, INCOSE 2026)]] — 40% productivity gains stat
- [[Interview 013 — David (Textile Manufacturing, Germany)]] — Pattern 28: campfire method
- [[Interview 022 — Marco Nortmeier (Filigran, Germany)]] — methodology-not-model confirmed
- [[Patterns From Fieldwork]] — Pattern 28 (campfire method), Pattern 25 (under-advised on AI)
