# MI — Neurofeedback for Corporate Brain Health (KEDAS Clinics)

#market-intelligence #neuroscience #succession #psychological-safety

> **Source:** KEDAS Clinics — webinar presentation transcript: "Understanding how neuroscience can help grow your business"
> **Speaker:** Don (forensic clinical psychologist, 23 years experience), with Tino (co-founder)
> **Date captured:** May 2026
> **Type:** Webinar transcript — neuroscience/corporate wellness

---

## What This Is

A forensic clinical psychologist presents a neurofeedback-based corporate wellness package (KEDAS Clinics). The core product: scheduled brain health checks (online) + remote neurofeedback therapy to improve cognitive performance, emotional regulation, and resilience in employees.
...
1. **Time the extraction before peak stress** — engage founders 2-3 years before the handover, not during. Post-announcement stress impairs the very knowledge transfer we need.
2. **Campfire = amygdala management** — the relaxed storytelling format isn't just user-friendly; it's neurologically necessary for accessing deep, contextual knowledge.
3. **Corporate wellness framing** — if we're selling to successors, the knowledge base also reduces THEIR cortisol (uncertainty is a major stressor). "Day 0 clarity" has a brain health benefit, not just a business benefit.

---

## Related
- [[Second Brain Landscape]] — broader landscape
- [[MI — Three Ways a Business Functions Like the Human Brain (MIT)]] — cortisol kills neurogenesis; same mechanism
- [[MI — Science of Entrepreneurs' Brains (US Chamber)]] — founder brain wiring; what succession destroys
- [[Interview 007 — Vetreria Rachello (Italy)]] — catastrophic succession; maximum cortisol scenario
- [[Interview 013 — David (Textile Manufacturing, Germany)]] — Pattern 29: tech must not feel like tech; campfire method
- [[Patterns From Fieldwork]] — Patterns 6-8 (emotional dimension), Pattern 29
