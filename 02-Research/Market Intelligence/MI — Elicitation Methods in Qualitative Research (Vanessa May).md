---
title: "MI — Elicitation Methods in Qualitative Research (Vanessa May)"
tags: [market-intelligence, knowledge-elicitation, methodology, qualitative-research]
created: 2026-05-19
---

## Source

- Professor Vanessa May (University of Manchester) — *Elicitation Methods in Qualitative Research* — webinar at the Methods Hub, University of Hong Kong. Covers photo elicitation and object elicitation as qualitative interview techniques.
...
The core premise: certain types of knowledge are impossible to surface through standard interview questions. Elicitation tools (photos, objects) unlock three categories specifically:

- **Embodied and sensory knowledge** — how something feels, sounds, smells; knowledge that was never encoded in language
...
A standard interview is an artificial situation. The elicitor sits opposite the expert and asks questions. This creates a power dynamic, a performance pressure, and a formality that suppresses candid knowledge.

Elicitation changes this in three ways:
- **Breaks direct eye contact** — looking at a photo or object together removes the interrogation dynamic; natural pauses feel comfortable
...
**Setup:** Ask participants to select photos in advance — either from existing albums or taken specifically for the session. Give them a framing prompt: "Bring photos that capture how the business really works, who matters to it, or what you're most proud of."

**Interview prompts that work:**
- "Why did you choose this particular photo?"
- "How does this photo capture what you were trying to show me?"
- "Why is this important to you?"
- "Is there anything this brings to mind that isn't in the photo itself?"
...
Objects outperform photos in one specific way: they engage the body. Research participants handle objects, point to them, compare them, pass them to the interviewer. This physical engagement activates sensory and embodied memory in a way photos can't.

Effective prompts:
- "Epiphenol" objects: meaningful, pivotal objects (a first product sample, a tool they've used for 30 years, a contract from a founding client)
- Mundane objects: everyday items that reveal how processes actually work (a worn tool, a handwritten ledger, a key to a building)
...
These three objects will produce more actionable tacit knowledge than three hours of structured questioning.

### 5. Participant-led selection = higher quality and less rationalisation

When the participant selects the photos or objects, they implicitly reveal what's meaningful — even before they say a word. The selection process itself is data.
...
May is explicit: "Usually we meet at least twice — once to explain, once to elicit." The first meeting builds rapport and explains the method so participants don't feel confused or anxious about why you want their objects or photos.
...
The week of preparation time is itself productive — the founder will start reflecting on what matters and why, which means the session begins with a warm, reflective participant rather than a cold, defensive one.

### 7. Elicitation is appropriate for sensitive topics — creates reflexive distance

Counterintuitively, elicitation works particularly well for sensitive subjects. Participants can "put boundaries around how much they tell" by shifting to the third person or discussing the object rather than themselves. The artefact provides safe distance.
...
1. **Add a physical artefact phase to Phase 1:** Ask the founder to bring 3 objects or photos before the structured session — one from the start, one from the hardest moment, one that represents the differentiator. The selection itself is data.
2. **Photo prompt script:** "Why this photo?" → "What does this make you think about that we haven't covered?" — not "tell me more about the photo itself"
3. **One week preparation window:** Brief founders on the artefact exercise a week ahead; the reflection time primes them for deeper extraction
4. **Broad framing outperforms specific prompts:** "Bring what feels significant" produces genuine choices; "bring a photo of production" produces curated safe ones
5. **The artefact is a door, not the subject:** Follow where the founder goes once it opens — don't interrogate the object

---

## Related

- [[MI — Classical Knowledge Elicitation Methods]] — KE engineering tradition; complementary disciplinary perspective
- [[MI — Storytelling and Tacit Knowledge Capture]] — SECI model; storyboarding; tacit knowledge externalization
- [[MI — Knowledge Elicitation for AI and ML]] — applying KE to LLM infusion; rationalisation trap
- [[Patterns From Fieldwork]] — Pattern 28 (Campfire method); this adds the artefact dimension
